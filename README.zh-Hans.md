...
🎓 **国立阳明交通大学（NYCU）全校师生专属 AI Agent 共学计划推荐版本**
...
> 🎓 **阳明交大师生专属分轨导读指引**：
> 为了满足阳明交大跨学科（电机资工、生医光电、管理、人文社会等）全校师生的多元需求，本学习地图特别设计了两条独立且互补的学习路径，读者可依据自身背景与研究/教学目的自由选择：
> 
...
>   * **学习重点**：深入技术底层与软件架构，从零用 Python 实作 ReAct 推理循环、设计数据流与内存架构（如记忆压缩与遗忘曲线）、实作工具的防御性校验与隔离沙箱，并深入设计多智能体（Multi-Agent）编排与死锁熔断机制。
